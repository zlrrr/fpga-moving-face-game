...
#
# Generated by Vivado on Tue Sep 11 12:32:36 +0800 2018
...
# Script info
echo -e "win_rom.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot win_rom xil_defaultlib.win_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim win_rom -key {Behavioral:sim_1:Functional:win_rom} -tclbatch cmd.tcl -log simulate.log
}
